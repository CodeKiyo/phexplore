...
class DestinationViewHolder(val itemView:View): RecyclerView.ViewHolder(itemView) {
    ...
    private val description: TextView? = itemView.findViewById(R.id.destDescription) as? TextView
    private val location: TextView? = itemView.findViewById(R.id.destLocation) as? TextView
